...
public class HistoryEarthquakeComparator implements
		Comparator<HistoryEarthquake> {

	private static Context ctx;

	@SuppressWarnings("static-access")
	public HistoryEarthquakeComparator(Context context) {
		this.ctx = context;
	}
	...
	@Override
	public int compare(HistoryEarthquake movie1, HistoryEarthquake movie2) {
		String rank1 = null;
		String rank2 = null;
