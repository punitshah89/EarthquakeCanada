...
public class HistoryEarthquakeAdapter extends BaseAdapter {

	private LayoutInflater mInflaterPhone;

	private List<HistoryEarthquake> eqDetails;
	...
	private ArrayList<HistoryEarthquake> arraylist;
	...
	public HistoryEarthquakeAdapter(Context context,
			List<HistoryEarthquake> eqDetails) {
		...
		this.arraylist = new ArrayList<HistoryEarthquake>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final HistoryEarthquake eq = eqDetails.get(position);
		if (convertView == null) {
	...
	public void filter(String charText) {
		...
		if (charText.length() == 0) {
			...
			for (HistoryEarthquake wp : arraylist) {
	 ...
	 */
	public void setListItems(List<HistoryEarthquake> list) {
		eqDetails = list;
	}
